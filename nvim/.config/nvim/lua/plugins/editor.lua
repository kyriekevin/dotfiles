return {
  ...
  {
    {
      ...
      config = function()
        ...
        vim.keymap.set("n", "<leader>ss", "<cmd>Telescope aerial<cr>", { desc = "Goto Symbol (Aerial)" })
  ...
  },
  {
    ...
    config = function()
      ...
      -- set keymap
      local keymap = vim.keymap -- for conciseness
      keymap.set("n", "<leader>vs", "<cmd>VenvSelect<cr>", { desc = "Select venv" })
      keymap.set("n", "<leader>vc", "<cmd>VenvSelectCached<cr>", { desc = "Select cached venv" })
    end,
  },
}
