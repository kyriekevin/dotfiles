...
sketchybar --add event applemusic_change $APPLE_MUSIC_EVENT \
	...
	y_offset=40 \
	\
	--add item applemusic.artist popup.applemusic.anchor --set applemusic.artist icon.drawing=off \
	y_offset=20 \
	background.padding_left=0 \
	background.padding_right=0 \
	width=0 \
	...
	width=0 \
	\
	--add item applemusic.shuffle popup.applemusic.anchor --set applemusic.shuffle icon=􀊝 \
	icon.padding_left=5 \
	...
	\
	--add item applemusic.repeat popup.applemusic.anchor --set applemusic.repeat icon=􀊞 \
	icon.highlight_color=$MAGENTA \
	icon.padding_left=5 \
	icon.padding_right=10 \
	icon.color=$BLACK \
	...
	\
	--add item applemusic.spacer popup.applemusic.anchor --set applemusic.spacer width=5 \
	\
	...
	applemusic.next \
	applemusic.repeat \
	--set applemusic background.color=$GREEN \
