...
| [cmux](https://github.com/manaflow-ai/cmux) | Preferred multi-agent control-plane experiment | Brewfile → `brew install --cask cmux`; workflow in [Agent Workflows](docs/agent-workflows.md) |
| [tmux](https://tmux.github.io/) | Optional low-level fallback dashboard | Brewfile → `brew install tmux`; workflow in [Agent Workflows](docs/agent-workflows.md) |
